...
/*
 * #Didn't see the point of re-inventing the wheel - this isn't my class I found it here: http://www.andrehonsberg.com/article/php-mysql-class-for-easy-and-simple-mysql-manipulation
 *
 * May not have been such a great idea - as it's throwing a warning as mysql_connect is deprecated! 
 *
 * I've modified it slightly to work with mysqli. 
 *
 */
...
class Database {
    ...
    public function query($sql) {
        if ($this->query = mysqli_query($this->link, $sql)) {
            ...
            $this->exception("Could not query database! query: $sql");
            return false;
        }
    }
